...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            key "s" action Show('rightmenu',dissolve)
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("{color=#000000}文字顯示速度")

                    bar value Preference("text speed")


                    label _("{color=#000000}自動前進時間")
